...
basedir=/opt/apps/ez/014050/se2bigquery/gcs/se2bigquery
source $basedir/common/configs_test.sh
START=$(date +%s)
...
spark-submit \
	 --driver-java-options "-Dlog4j.configuration=file:$log4j_properties -Dlogfile.name=se2bq -Dspark.yarn.app.container.log.dir=/opt/apps/ez/014050/se2bigquery/gcs/log" \
